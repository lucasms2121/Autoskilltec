      ...
      <div ref={contentRef} className="max-w-2xl mx-auto opacity-0">
        ...
        {isSubmitSuccessful ? (
          ...
          >
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "16px", color: "#CECEE8", lineHeight: 1.7 }}>
            ...
            <div className="flex flex-wrap justify-center gap-6 pt-2">
              {[
                ...
                <div key={text} className="flex items-center gap-2">
                  <Icon size={14} color="#CECEE8" />
                  <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "12px", color: "#CECEE8" }}>
                    {text}
                  </span>
                </div>
              ))}
